...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap) {
        ...
        leftRear = hardwareMap.get(DcMotorEx.class, "10");
    ...
    public double getCurrent(int motor) {
        switch (motor) {
            case 0:
                return rightRear.getCurrent(CurrentUnit.AMPS);
            case 1:
                return rightFront.getCurrent(CurrentUnit.AMPS);
            case 2:
                return leftRear.getCurrent(CurrentUnit.AMPS);
            case 3:
    ...
    public Double getExternalHeadingVelocity() {
        return (double) imu.getAngularVelocity().yRotationRate; //changed from "zRotationRate" to "xRotationRate"
    }
