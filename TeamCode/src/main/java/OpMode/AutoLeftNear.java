...
/**
 * Left side start, scores on near (aka contested) high pole
 */
@Autonomous
public class AutoLeftNear extends Auto
{
    //PIDF CONSTANTS
    ...
    //Trajectories
    Pose2d startPose = new Pose2d(35.5, 60.2, Math.toRadians(90));
    ...
    int[] extendPositions = {420, 410, 400, 395, 390};
    ...
    public void start() {
        ...
        traj1 = drive.trajectoryBuilder(startPose)
                ...
                .splineToSplineHeading(new Pose2d(34.5, -6, Math.toRadians(193)), Math.toRadians(-90))
                .build();
        traj4 = drive.trajectoryBuilder(traj1.end())
                .splineToLinearHeading(new Pose2d(33, 4, Math.toRadians(180)), Math.toRadians(193))
                .build();
