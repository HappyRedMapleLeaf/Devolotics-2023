...
/**
 * Left side start, scores on far (aka uncontested) high pole
 */
@Autonomous
public class AutoLeftFar extends Auto
{
    //PIDF CONSTANTS
    ...
    //Trajectories
    Pose2d startPose = new Pose2d(36, 60.2, Math.toRadians(90));
    ...
    //2nd and second to the last

    int[] hPitchPositions = {470, 622, 417, 568, 353, 496, 290, 457, 245, 270};
    int[] clawPitchPositions = {440, 436, 404, 380, 351, 352, 276, 333, 255, 255};
    int[] extendPositions = {1000, 995, 990, 980, 975};
    ...
    public void start() {
        ...
        traj1 = drive.trajectoryBuilder(startPose)
                ...
                .splineToSplineHeading(new Pose2d(12.9, 11.5, Math.toRadians(169)), Math.toRadians(290))
                .build();
        traj4 = drive.trajectoryBuilder(traj1.end())
                .splineToLinearHeading(new Pose2d(10, 4, Math.toRadians(180)), Math.toRadians(168))
                .build();
    ...
    public void loop() {
        ...
        if (line < program.size()) {
            ...
            switch (func) {
                ...
                case 22:
                    //intakesensor1
                    eTargetTarget = extendPositions[arg1] + 50 + 120;
                    eTarget += 120;
                    changeLine = true;
                    eSpeed = 4;
                    break;
                case 23:
                    //intakesensor2
                    if (distanceSensor.getDistance(DistanceUnit.MM) < 20 || eSpeed == 0) {
                        changeLine = true;
                        eTarget -= 20;
                        eTargetTarget -= 20;
                        eSpeed = 0;
    ...
    public void buildProgram() {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            setMotorPos(EXTEND, extendPositions[i] - 160, 55);
            waitTime(150);
            setServoPos(VCLAW, vClawClose);
