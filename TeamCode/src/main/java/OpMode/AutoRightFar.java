...
/**
 * Right side start, scores on far (aka uncontested) high pole
 */
@Autonomous
public class AutoRightFar extends Auto
{
    //PIDF CONSTANTS
    ...
    //Trajectories
    Pose2d startPose = new Pose2d(-38, 60.2, Math.toRadians(90));
    ...
    int[] extendPositions = {1000, 990, 985, 980, 985};
    ...
    public void start() {
        ...
        traj1 = drive.trajectoryBuilder(startPose)
                ...
                .splineToSplineHeading(new Pose2d(-6, 11, Math.toRadians(7)), Math.toRadians(250))
                .build();
        traj4 = drive.trajectoryBuilder(traj1.end())
                .splineToLinearHeading(new Pose2d(-5, 2, Math.toRadians(0)), Math.toRadians(5.3))
                .build();
    ...
    public void loop() {
        ...
        if (line < program.size()) {
            ...
            switch (func) {
                ...
                case 22:
                    //intakesensor1
                    eTargetTarget = extendPositions[arg1] + 50 + 130;
                    eTarget += 130;
                    changeLine = true;
                    eSpeed = 5;
                    break;
